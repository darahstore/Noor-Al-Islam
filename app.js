...
// ==========================================
// دالة تطبيق حجم المسبحة الرقمية (النسخة المُصلحة)
// ==========================================
function applySebhaSize(size) {
    const numericSize = parseFloat(size) || 1;
    
    // محاولة استهداف الحاوية الرئيسية (إن وجدت)
    const mainContainer = document.getElementById('digital-tally-counter');
    
    // استهداف زر التسبيح وشاشة العداد مباشرة (لضمان عمل الكود)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    applyFontSize();
    applySebhaSize(StorageManager.state.sebhaSize || 1);
