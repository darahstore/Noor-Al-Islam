...
function initSebhaEngine() {
    ...
    tallyBtn.addEventListener('click', () => {
        ...
        // 2. تشغيل صوت النقر عند الضغط على زر العد
    ...
    resetBtn.addEventListener('click', () => {
        ...
        // 2. تشغيل صوت النقر عند الضغط على زر إعادة الضبط
        if (StorageManager.state.soundVib) {
            sebhaClickSound.currentTime = 0;
            sebhaClickSound.play().catch(e => {});
        }
    ...
    // 5. منطق قفل الثيمات للنسخة المدفوعة (Pro): default هو المجاني الوحيد وباقي الثيمات تتطلب Pro أو إعلان
